...
def numbered_pin(x, y, n, r=6.8, color="#12496b"):
    fs = 8 if r <= 7 else 9
    return (f'<g><circle cx="{x}" cy="{y}" r="{r}" fill="{color}" stroke="white" stroke-width="1.4"/>'
...
def legend_x(color, size=18):
    return (f'<svg class="duo-x" viewBox="0 0 20 20" aria-hidden="true">'
